    ...
    style={{ backgroundImage: `url(${Background})`}} >
        ...
        <div className="wrapper mx-auto sm:pb-8 ">
          ...
          <div className="flex justify-center flex-col items-center md:gap-7 sm:gap-3ss my-auto ">
            <h3 className="md:text-7xl sm:text-2xl text-center text-white">It all starts here.</h3>
            <div className="grid grid-cols-2 md:grid-flow-col md:w-8/12 sm:w-12/12 gap-3  sm:flex sm:flex-col">
              <div className="flex flex-col justify-between rounded-xl px-2 md:py-9 sm:py-5 w-full row-span-1 bg-[#69C080] bg  content-center mx-auto  ">
                <h4
                  
                  className=" md:text-3xl sm:text-2xl text-center text-white"
                >
              ...
              <div className="flex flex-col justify-between rounded-xl px-2 md:py-9 sm:py-5 w-full row-span-1 bg-[#69C080]   content-center mx-auto  ">
                <h4
