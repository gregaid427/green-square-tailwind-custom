...
function Faq(props) {
  ...
  return (
    ...
    <div className="flex gap-5 text-md faq-ans py-2 " style={{background:"rgb(248 250 252)",borderLeft: '8px solid #93A3A1', paddingLeft:20,paddingRight:5 , }} ><h5 className="font-bold">A.</h5> <h5>{props.info}</h5></div>
    </div>
    </>
  );
}
